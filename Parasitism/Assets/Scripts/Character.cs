...
public class Character : MonoBehaviour
{
    ...
    public void Change()
    {
        ...
        {
            case 0:
                gameObject.transform.localScale = new Vector3(Turn * 0.75f, 0.75f, 0.75f);
                physicsCheck.checkRaduis = OriginalRaduis * 0.75f;
                break;
            case 1:
                gameObject.transform.localScale = new Vector3(Turn * 1f, 1f, 1f);
                physicsCheck.checkRaduis = OriginalRaduis;
                break;
            case 2:
                gameObject.transform.localScale = new Vector3(Turn * 1.5f, 1.5f, 1.5f);
                physicsCheck.checkRaduis = OriginalRaduis * 1.5f;
                break;
            case 3:
                gameObject.transform.localScale = new Vector3(Turn * 2f, 2f, 2f);
